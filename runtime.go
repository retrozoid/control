...
type jsObject runtime.RemoteObjectId

func (j jsObject) ObjectID() runtime.RemoteObjectId {
	return runtime.RemoteObjectId(j)
}
...
func toOptionalNode(value any, err error) OptionalNode {
	...
	if value == nil {
		return OptionalNode{Err: ErrElementIsNotFound}
	}
